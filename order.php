...
<head>
	...
	<title>Bliss Brews - order page</title>
</head>
<body>
	...
	<div class="main">
		...
		<section class="orders">
				<div class="title">
					...
					<h1>my orders</h1>
					<p>Your Bliss Brews order has been carefully processed to bring enjoyment to every sip!</p>
				</div>
					...
					<div class="box" <?php if($fetch_order['status']=='cancle'){echo 'style="border:2px solid red";';} ?>>
						<a href="view_order.php?get_id=<?= $fetch_order['id']; ?>">
							...
							<div class="row">
								...
								<p class="status" style="color:<?php if($fetch_order['status']=='delivered'){echo 'golden';}elseif($fetch_order['status']=='canceled'){echo 'red';}else{echo 'red';} ?>"><?= $fetch_order['status']; ?></p>
							</div>
						</a>
