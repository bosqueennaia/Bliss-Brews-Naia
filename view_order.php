...
<head>
	...
	<title>Bliss Brews - order detail page</title>
</head>
<body>
	...
	<div class="main">
		...
		<section class="order-detail">
				<div class="title">
					...
					<h1>order detail</h1>
					<p>Your Bliss Brews order has been carefully processed to bring enjoyment to every sip!
                </p>
				</div>
				<div class="box-container">
					...
					<div class="box">
						...
						<div class="col">
							...
							<p class="status" style="color:<?php if ($fetch_order['status']=='delevered'){echo 'golden';}elseif($fetch_order['status']=='canceled') {echo 'red';}else{echo 'red';}?>"><?=$fetch_order['status'] ?></p>
