	...
	<div class="main">
		...
		<div class="address">
			 	<div class="title">
			 		...
			 		<p>Find right away via the contact information below to start a coffee adventure with bliss brews !</p>
					<html lang="en">
					<head>
						<meta charset="UTF-8">
						<meta name="viewport" content="width=device-width, initial-scale=1.0">
			 	...
			 	<div class="box-container">
			 		<div class="box">
					 	<i class='bx bx-map-pin bx-tada' ></i>
			 			<div>
			 				<h4>address</h4>
			 				<p>Antasari, Jakarta Selatan</p>
			 			</div>
			 		</div>
			 		<div class="box">
